...
SELECT b.break_id, cocoa_name, location_name
FROM locations l RIGHT JOIN break_schedule b
ON l.location_id = b.location_id
JOIN cocoa_logs cl ON cl.break_id = b.break_id
JOIN cocoa_types ct ON ct.cocoa_id = cl.cocoa_id;
